...
<body>
    <!--inicio cabeçalho-->
    <header>
        <nav class="navbar navbar-fixed-top navbar-expand-md navbar-light bg-light shadow-sm p-3 mb-5 bg-#c8ead9 rounded">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="nav-principal">
                    <ul class="navbar-nav list-unstyle ml-auto">
                        <li class="nav-item"><a href="#cadastrar" class="btn btn-outline">Cadastre-se</a>
                        </li>
                    </ul>
                </div>
                <form class="navbar-form navbar-right" role="login">
                    <div class="form-inline">
                        <ul class="nav navbar-nav navbar-right">
                            <li><input type="text" name="email" id="email" class="form-control" placeholder="Digite seu e-mail"></li>
                            <li><input type="password" name="password" id="password" class="form-control" placeholder="Digite sua senha"></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="d-flex justify-content-center">
                            <img src="img/save.png" alt="imagem mãos segurando a terra" class="img_principal">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="cadastrar">
        <div class="container-fluid row d-flex">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-flex justify-content-center">
                    <img src="img/connection.png" alt="imagem lotus" class="img_form">
                </div>
            </div>
            <div class="col-6">
                <h3>Junte-se à nós!</h3>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate enim temporibus ut adipisci, dolorum perspiciatis! Quas odio ratione exercitationem eos vel, labore harum, est distinctio officia ut reprehenderit at corrupti?</p>
                <form>
