    ...
    <section class="row">
        ...
        <article class="col-12 col-md-6">
            <p class="text-justify">Somos uma Rede Social brasileira dedicada à ações que as pessoas quiserem realizar
                ...
                expostos a tantos entulhos, lixos, despejados por empresas e mesmo por indivíduos. Para tanto nos
                baseamos numa teoria: A Teoria das Janelas quebradas. <strong>Fixing Broken Windows: Restoring Order and
                ...
                lixo." Uma estratégia de êxito para prevenir o vandalismo, dizem os autores do estudo, é resolver os
