    ...
    <main class="container mt-5 p-5">
        <section class="row" id="about-us">
            ...
            <article class="d-flex justify-content-center mt-5">
                <img src="img/volunteer.jpg" alt="mão com coração" class="w-25 ml-5">
            </article>

            <h2 class="col-12 mt-5">Sobre nós</h2>
