                        ...
                        <nav class="navbar fixed-top navbar-expand-md navbar-light shadow-sm">
                            <div class="container">
                                ...
                                <div class="collapse navbar-collapse" id="nav-principal"
                                    class="header-paginas-internas">
                                    <ul class="navbar-nav list-unstyle ml-auto">
                                        <li class="nav-item"><a href="#" class="nav-link text-success">Comunidades</a>
                                        </li>
                                        <li class="nav-item"><a href="#" class="nav-link text-success">Criar evento</a>
                                        </li>
                                        <li class="nav-item"><a href="event" class="nav-link text-success">Eventos</a>
                                        </li>
                                        <li class="nav-item"><a href="#" class="nav-link text-success">Perfil</a></li>
                                        <li class="nav-item"><a class="nav-link text-success"
                                                href="{{ route('logout') }}" onclick="event.preventDefault();
>>>>>>> 42ecd3901072a27019ee8e990c53f28183391d32
        ...
        <!--fim cabeçalho-->
>>>>>>> 265572c9ed2f14eaf95a2d340403bed65729ce1c
        <main>
            @yield('content')
        </main>
       @yield("footer")
