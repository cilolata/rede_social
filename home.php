            ...
            <section class="pesquisar">
                ...
                <div class="d-flex mt-4">
                    <div class="input-group d-flex justify-content-center">
                        <input type="text" class="input-group-text bg-white" style="width:500px;" id=""
                            placeholder="Pesquisar">
                        <button type="button" class="btn btn-link"><img src="img/search.png" style="width:40px;"
                                class="ml-2" alt=""></button>
                    </div>
                </div>
            </section>
